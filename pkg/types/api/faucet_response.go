...
type FaucetResponse struct {
	...
	MaxBalance      hexutil.Big       `json:"maxBalance,omitempty" validate:"required,isBig" example:"0x16345785D8A0000" swaggertype:"string"`
	Amount          hexutil.Big       `json:"amount,omitempty" validate:"required,isBig" example:"0xD529AE9E860000" swaggertype:"string"`
