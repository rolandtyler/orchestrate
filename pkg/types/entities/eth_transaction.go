...
type ETHTransaction struct {
	...
	From            *ethcommon.Address `json:"from,omitempty" validate:"omitempty,eth_addr" example:"0x1abae27a0cbfb02945720425d3b80c7e09728534"`
	To              *ethcommon.Address `json:"to,omitempty" validate:"omitempty,eth_addr" example:"0x1abae27a0cbfb02945720425d3b80c7e09728534"`
	Nonce           *hexutil.Uint64    `json:"nonce,omitempty" validate:"omitempty" example:"0x1" swaggertype:"string"`
